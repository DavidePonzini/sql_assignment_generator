...
ERROR_DETAILS_MAP = {
    ...
    SqlErrors.SYN_21_COMPARISON_WITH_NULL: SqlErrorDetails(
        ...
        constraints={
            ...
            # DifficultyLevel.MEDIUM: ["must have 1 CREATE TABLE", "must have 4 COLUMNS per table", "must have 3 WHERE condition", "must have AGGREGATION"],
            # DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 WHERE condition", "must have SUB-QUERY", "must have 2 AGGREGATION"]
        }
    ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have DISTINCT", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have DISTINCT", "must have 3 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #     constraints={
    #         DifficultyLevel.EASY: ["must have 1 CREATE TABLE", "must have 2 COLUMNS per table", "must have 2 WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 NOT in WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 NOT in WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #     constraints={
    #         DifficultyLevel.EASY: ["must have 1 CREATE TABLE", "must have 2 COLUMNS per table", "must have NOT in WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NOT in WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 2 NOT in WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 3 CREATE TABLE", "must have 4 COLUMNS per table", "must have NOT EXIST in WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 2 NOT EXIST in WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #     constraints={
    #         DifficultyLevel.EASY: ["must have 1 CREATE TABLE", "must have 2 COLUMNS per table", "must have EXIST or IN in WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 3 CREATE TABLE", "must have 4 COLUMNS per table", "must have EXIST or IN in WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have EXIST or IN in WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),            
    ...
    #         DifficultyLevel.MEDIUM: ["must have 3 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 COMPARISON OPERATOR in WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 COMPARISON OPERATOR in WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 3-4 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 JOIN", "must have 2 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 4-6 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 JOIN", "must have 3 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.EASY: ["must have 2 CREATE TABLE", "must have 2 COLUMNS per table", "must have JOIN", "must have WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 3-4 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 JOIN", "must have 2 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 4-6 CREATE TABLE", "must have 6 COLUMNS per table", "must have 2 JOIN", "must have 3 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 3 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO SUB-QUERY", "must have 2 NESTED WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO SUB-QUERY", "must have 2 NESTED WHERE condition", "must have AGGREGATION"]
    ...
    #         DifficultyLevel.MEDIUM: ["must have 3 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 WHERE condition", "must have SUB-QUERY NOT NESTED"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY NOT NESTED"]
    #     }
    # ),
    ...
    #         DifficultyLevel.EASY: ["must have 1 CREATE TABLE", "must have 2 COLUMNS per table", "must have 2 WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 4 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 3 WHERE OR HAVING condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 4 WHERE OR HAVING condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have DISTINCT", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have DISTINCT", "must have 4 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have  2 columns in ORDER BY", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 columns in ORDER BY", "must have 4 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO ORDER BY", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO ORDER BY", "must have 4 WHERE condition", "must have AGGREGATION", "must have SUB-QUERY"]
    #     }
    # ),     
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 AGGREGATION", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 3 AGGREGATION", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #     constraints={
    #         DifficultyLevel.EASY: ["must have 1 CREATE TABLE", "must have 2 COLUMNS per table", "must have 2 WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have AGGREGATION", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have AGGREGATION", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #     constraints={
    #         DifficultyLevel.EASY: ["must have 2 CREATE TABLE", "2 table must have same PK", "must have 2 COLUMNS per table", "must have 2 WHERE condition"],
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "2 table must have same PK", "must have 4 COLUMNS per table", "must have AGGREGATION", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "2 table must have same PK", "must have 6 COLUMNS per table", "must have AGGREGATION", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),                         
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have AGGREGATION", "must have 2 WHERE condition without WILDCARDS"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have AGGREGATION", "must have 3 WHERE condition without WILDCARDS", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 2 EXIST in WHERE condition", "must 2 have SUB-QUERY"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have AGGREGATION", "must have 3 EXIST in WHERE condition", "must 3 have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO AGGREGATION", "must have 2 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO AGGREGATION", "must have 3 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have AGGREGATION", "must have 2 WHERE condition", "must 2 have SUB-QUERY"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have AGGREGATION", "must have 3 WHERE condition", "must 3 have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO AGGREGATION", "must have GROUP BY", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO AGGREGATION", "must have GROUP BY", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO GROUP BY", "must have 2 AGGREGATION", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO GROUP BY", "must have 3 AGGREGATION", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO GROUP BY", "must have DISTINCT", "must have 3 WHERE condition"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO GROUP BY", "must have DISTINCT", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have NO UNION", "must have 3 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have NO UNION", "must have 4 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have 3 columns in ORDER BY", "must have 2 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 4 columns in ORDER BY", "must have 3 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have UNION or UNION ALL", "must have 2 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have UNION or UNION ALL", "must have 3 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
    ...
    #         DifficultyLevel.MEDIUM: ["must have 2 CREATE TABLE", "must have 4 COLUMNS per table", "must have LEFT OUTHER JOIN", "must have 2 WHERE condition", "must have AGGREGATION"],
    #         DifficultyLevel.HARD: ["must have 3-5 CREATE TABLE", "must have 6 COLUMNS per table", "must have 2 LEFT OUTHER JOIN", "must have 3 WHERE condition", "must have SUB-QUERY"]
    #     }
    # ),
